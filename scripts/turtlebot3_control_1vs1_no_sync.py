...
attacker_data = TransformStamped()
defender_data = TransformStamped()

def vicon_callback(msg, args):
    global attacker_data
    global defender_data
...
if __name__ == "__main__":
    ...
    attacker_sub = rospy.Subscriber('/vicon/turtlebot3_2/turtlebot3_2', TransformStamped,vicon_callback, 'attacker', queue_size=30)
    defender_sub = rospy.Subscriber('/vicon/turtlebot3_3/turtlebot3_3', TransformStamped,vicon_callback, 'defender', queue_size=30)
