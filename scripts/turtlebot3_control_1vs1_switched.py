...
def vicon_data_callback(attacker_data: TransformStamped, defender_data: TransformStamped):
    ...
    attacker_pub = rospy.Publisher("/turtlebot3/cmd_vel", Twist, queue_size=30)
    defender_pub = rospy.Publisher("/turtlebot2/cmd_vel", Twist, queue_size=30)
    # Filter the raw data
...
if __name__ == "__main__":
    ...
    attacker_sub = Subscriber('/vicon/turtlebot3_3/turtlebot3_3', TransformStamped, queue_size=30)
    defender_sub = Subscriber('/vicon/turtlebot3_2/turtlebot3_2', TransformStamped, queue_size=60)


    ts = TimeSynchronizer([attacker_sub, defender_sub], queue_size=90)
